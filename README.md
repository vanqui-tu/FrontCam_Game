...
## Flow: EntryChoiceActivity -> ChooserActivity -> LivePreviewActivity
2 activity đầu có thể chuyển đổi sang mục đích khác. Activity cuối là màn hình chính.

## File GraphicOverlay (quan trọng). Các file tên chứa "Graphic" khác dựa vào file này để vẽ các lớp overlay lên màn hình

## Folder preference: cấu hình model và trang Settings, các settings được lưu lại trong preference cho đến các lần sau

## Folder facedetector, file VisionProcessorBase và các file liên quan: Model và xử lý hình ảnh